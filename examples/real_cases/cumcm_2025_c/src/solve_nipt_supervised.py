...
"""
    ...
    parse = {
        ...
        "question_count": 3,
        "attachments": ["data/nipt_male_synthetic.csv", "data/nipt_female_synthetic.csv"],
    ...
    task_plan = {
        ...
        "rubric_targets": [
            ...
            {"criterion": "supervised_rework", "target": "validation audit records revise -> rework -> pass", "evidence": "results/validation_audit.md"},
        ],
        "question_count": 3,
        "subquestions": [
            {
                ...
                "input_data": ["data/nipt_male_synthetic.csv"],
            ...
            },
            {
                ...
                "input_data": ["data/nipt_male_synthetic.csv", "Q1 model"],
            ...
            },
            {
                ...
                "input_data": ["data/nipt_female_synthetic.csv"],
...
- `results/validation_audit.md` 记录 revise、rework、recheck 证据。
...
def run(draft: bool) -> int:
    for directory in [DATA_DIR, FIGURE_DIR, TABLE_DIR, RESULT_DIR, PAPER_DIR, PROBLEM_DIR]:
