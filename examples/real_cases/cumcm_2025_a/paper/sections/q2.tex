...
由于问题二属于优化问题，除给出推荐策略外，还需说明该策略附近的稳定性。图 \ref{fig:q2-sensitivity} 对速度、航向角、投放时刻和引信延迟做单因素扰动，比较遮蔽时长的变化。该图用于提醒论文中不能只写“搜索得到最优”，还要说明推荐方案对关键变量扰动是否敏感。

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.94\linewidth]{../figures/fig_q2_sensitivity.png}
  \caption{问题二推荐策略的局部敏感性检查。各子图分别扰动一个决策变量，红色虚线表示当前推荐策略的遮蔽时长。}
