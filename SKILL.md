...
description: |
  ...
  Use when the user mentions 全国大学生数学建模竞赛, CUMCM, 数学建模,
  建模论文, 赛题分析, 模型建立, 模型求解, 技术路线图, 模型流程图,
  灵敏度分析, 摘要, 一等奖标准, or asks to turn a contest problem/data
  into a rigorous modeling solution and report.
  ...
  ordinary document polishing, or pure coding bug fixes unless the user explicitly
  wants a mathematical-modeling contest workflow.
---
